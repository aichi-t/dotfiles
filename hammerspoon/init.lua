...
hs.hotkeyextension.bind(appManagerModifiers, 'c', launchOrFocus('Visual Studio Code'))
hs.hotkeyextension.bind(appManagerModifiers, 'x', launchOrFocus('Slack'))
hs.hotkeyextension.bind(appManagerModifiers, 'g', launchOrFocus('Google Chrome'))
hs.hotkeyextension.bind(appManagerModifiers, 'b', launchOrFocus('Brave Browser'))
hs.hotkeyextension.bind(appManagerModifiers, 's', launchOrFocus('Simplenote'))
hs.hotkeyextension.bind(appManagerModifiers, 'e', launchOrFocus('Finder'))
hs.hotkeyextension.bind(appManagerModifiers, 'p', launchOrFocus('Bitwarden'))
hs.hotkeyextension.bind(appManagerModifiers, 'l', launchOrFocus('Line'))
hs.hotkeyextension.bind(appManagerModifiers, 't', launchOrFocus('TickTick'))
hs.hotkeyextension.bind(appManagerModifiers, 'n', launchOrFocus('Notion'))
hs.hotkeyextension.bind(appManagerModifiers, 'm', launchOrFocus('FL Studio 20'))
hs.hotkeyextension.bind(appManagerModifiers, 'i', launchOrFocus('iTerm'))
hs.hotkeyextension.bind(appManagerModifiers, 'a', launchOrFocus('Anki'))
hs.hotkeyextension.bind(appManagerModifiers, 'f', launchOrFocus('Firefox'))
hs.hotkeyextension.bind(appManagerModifiers, 'z', launchOrFocus('zoom.us'))
